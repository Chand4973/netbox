...
Report bugs at https://github.com/RajGupta15082004/Netping-Monitor/issues.
...
Netping Monitor could always use more documentation, whether as part of the
official Netping Monitor docs, in docstrings, or even on the web in blog posts,
articles, and such.

### Submit Feedback

The best way to send feedback is to file an issue at https://github.com/RajGupta15082004/Netping-Monitor/issues.
...
Ready to contribute? Here's how to set up `Netping-Monitor` for local development.

1. Fork the `Netping-Monitor` repo on GitHub.
2. Clone your fork locally

    ```
    $ git clone git@github.com:your_name_here/Netping-Monitor.git
    ```
...
3. The pull request should work for Python 3.8, 3.9, 3.10 and 3.11. Check
   https://github.com/RajGupta15082004/Netping-Monitor/actions
